                        ...
                        <c:forEach var="category" items="${categoryList}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="${pageContext.request.contextPath}/deleteCategory/${category.categoryId}"
                                       class="btn btn-danger btn-delete" onclick="if (!(confirm('Are you sure you want to delete this Category?')))
