...
<section>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="${pageContext.request.getContextPath()}/deleteProducer">Detele Producer</a>
                            </li>
    ...
    <h2 style="text-align: center;">ADD NEW PRODUCER</h2>
    <div class="row ">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            
            <div class="card">
                <div class="body">
                    <form:form action="${pageContext.request.contextPath}/saveProducer" cssClass="form-horizontal" method="post" modelAttribute="producer">

                        <form:hidden path="producerId" />

                        <div class="form-group">
                            <label for="producerName" class="col-md-3 control-label">Producer Name:</label>
                            <div class="col-md-4">
                                <form:input path="producerName" cssClass="form-control" />                           
                        </div>
                    </div>
                </div>
