...
<!--
    <link href='${pageContext.request.getContextPath()}/resources/css/bootstrap.min.css'
              rel="stylesheet">
    <link href='${pageContext.request.getContextPath()}/resources/css/font-awesome.min.css'
              rel="stylesheet">
    <link href='${pageContext.request.getContextPath()}/resources/css/prettyPhoto.css'
              rel="stylesheet">
    <link href='${pageContext.request.getContextPath()}/resources/css/price-range.css'
              rel="stylesheet">
    <link href='${pageContext.request.getContextPath()}/resources/css/animate.css'
              rel="stylesheet">
    <link href='${pageContext.request.getContextPath()}/resources/css/main.css'
              rel="stylesheet">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Hot Products</h2>
                                                ...
                                                <c:if test="${pageContext.request.getContextPath()}/listAllProductHot" >
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>${tempProductHot.price}</h2>
                                                                                                <p>${tempProductHot.productName}</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Product Detail</a>
                                                ...
                                                <c:if test="${pageContext.request.getContextPath()}/listAllProductNew">
